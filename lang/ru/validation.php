...
return [
    ...
    'accepted_if' => 'Поле :attribute обязательно, когда :other равно :value.',
    ...
    'decimal' => 'В поле :attribute должно быть :decimal знаков после запятой.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Поле :attribute обнаружено в утечке данных. Выберите другое значение.',
    ],
    ...
    'attributes' => [
        ...
        'type' => 'тип акции',
        'active' => 'активность',
        'category_id' => 'категория акции',
        'product_id' => 'товар',
        'buy_quantity' => 'количество платных в комплекте',
        'free_quantity' => 'количество бесплатных в комплекте',
